...
// Bumped to v5: pull-to-refresh was removed from the dashboard shell, so the
// precached "/" from v4 has to be evicted or a returning device keeps the old one.
const CACHE_NAME = "apsara-spend-v5";
